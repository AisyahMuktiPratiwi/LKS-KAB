...
<body>
	<header>
		<div class="container">
			<h1><a href="index.php/dashboard">HappaiShop</a></h1>
			<p>
			<p><a href="auth/login"><img src="<?php echo base_url(); ?>upload/log.png" style="width: 30px; margin-top: 14px; margin-left: 200px; margin-bottom: 10px;"></a>
				<a href="registrasi/regis"><img src="<?php echo base_url(); ?>upload/e.png" style="width: 40px; margin-top: 10px; margin-left: 20px;  margin-bottom: 10px;"> </a>

				<span style="margin-left: 250px; "><?php $keranjang = 'Keranjang' . $this->cart->total_items() . 'items' ?>
					<?php echo anchor('dashboard/detail_keranjang', $keranjang) ?> </span>


				<a href="logadmin/login"><img src="<?php echo base_url(); ?>upload/admin.png" style="width: 40px; margin-top: 10px; margin-left: 100px; margin-bottom: 10px;">
			</p>
		</div>
	</header>
	...
	<header style="margin-top: 1rem;">
		<div class="container">
			<ul style="float:left; margin-left: 250px;">
				...
				<li>
					<h2 style="margin-left: 20px;"><a href="index.php/dashboard/pembayaran">Checkout</a></h2>
				</li>
				<li>
	...
	<div class="section">
		<div class="container" style="color: white;">
			...
			<div class="box" style="background-color: plum; ">
				<a href="<?php echo base_url('kategori/pakaianwanita') ?>">
					<div class="col-5">
